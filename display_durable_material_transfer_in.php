            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger">
                  <i class="fas fa-box-open"></i> แสดงข้อมูลการโอนเข้า(วัสดุคงทน)</h6>
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-primary" type="button" onclick="window.location.href='print_durable_material_transfer_in.php';">
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      <?php
                      $sqlSelect = "SELECT trans.*, ar.code FROM durable_material as ar, durable_material_transfer_in as trans";
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center">
                          ...
                          <button type="button" rel="tooltip" class="btn btn-warning"
                            ...
                            <button type="button" rel="tooltip" class="btn btn-primary" onclick="window.location.href='print_durable_material_transfer_in.php';">
                            <i class="fas fa-print"></i>
                          </button>
