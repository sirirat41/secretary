      ...
      <div class="row">
            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h5 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-archive"></i> แสดงข้อมูลการบริจาคออก(ครุภัณฑ์)</h5>
                ...
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    if (isset($_GET["keyword"])) {
                      ...
                      $sqlSelect .= " and (do.donate_name like '%$keyword%' or a.code like '%$keyword%' or do.receive_date like '%$keyword%' or do.document_no like '%$keyword%')";
                    }
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <?php
            $sqlSelectCount = "SELECT do.*, a.code FROM durable_articles_donate as do, durable_articles as a";
            $sqlSelectCount .= " WHERE do.product_id = a.id and do.status = 0";
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (do.donate_name like '%$keyword%' or a.code like '%$keyword%' or do.receive_date like '%$keyword%' or do.document_no like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          ...
          <form id="form-rowback" method="post" action="service/service_rowback_durable_articles_donate.php">
