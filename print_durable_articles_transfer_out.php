...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT t.*, a.code ,a.attribute , a.model , a.picture  ,au.Aname ,au.position ,au.rank FROM durable_articles as a,durable_articles_transfer_out as t ,auditor as au WHERE t.id = $id";
  ...
  <div class="col-sm-12">
    <div class="table-responsive" align="center">
      <table width="900" border="1" align="center">
        <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลการโอนออก(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
    </div>
    </nav>
    <form>
      <div class="card-body">
