...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT p.*, a.code ,a.attribute ,a.model , a.picture , au.rank ,au.Aname ,au.position FROM durable_articles_purchase as p ,durable_articles as a ,auditor as au WHERE p.id = $id";
  ...
  <div class="col-sm-12">
    <div class="table-responsive" align="center">
      <table width="900" border="1" align="center">
        <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลจัดซื้อ(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
        <form>
          <div class="card-body">
            <div class="row">
