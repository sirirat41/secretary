...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM durable_articles_receive_donate as d,durable_articles as a WHERE d.id = $id";
        ...
        <div class="col-md-8 offset-md-2">
          <div class="card shado mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger body-text"><i class="fas fa-archive"></i> แก้ไขข้อมูลรการับบริจาค(ครุภัณฑ์)</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control body-text" name="document_no" id="inputdocument_no" aria-describedby="document_no" placeholder="documentno" value="<?php echo $item["document_no"]; ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group body-text">
                      <label for="receive_date">วันที่รับบริจาค</label>
                      <input type="date" class="form-control body-text" name="receive_date" id="inputreceive_date" aria-describedby="receive_date" placeholder="" value="<?php echo $newReceivedate; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control body-text" name="donate_name" id="inputdonate_name" aria-describedby="donate_name" placeholder="donatename" value="<?php echo $item["donate_name"]; ?>">
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="form-group body-text">
                      <label for="number">ราคา</label>
                      <input type="text" class="form-control body-text" name="number" id="inputnumber" aria-describedby="number" placeholder="price" value="<?php echo $item["number"]; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
