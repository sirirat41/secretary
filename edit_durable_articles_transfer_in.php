...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM durable_articles_transfer_in as t ,durable_articles as a WHERE t.id = $id";
                      ...
                      <div class="row">
                        <div class="col-10 ">
                          <select class="form-control body-text" name="product_id" id="product_id" value="<?php echo $item["product_id"]; ?>">
                            <?php
                            $sqlSelectType = "SELECT * FROM durable_articles WHERE status = 5";
                ...
                <div class="card-header py-3">
                  <nav class="navbar navbar-light bg-light">
                    <h5 class="m-0 font-weight-bold text-danger">
                      <i class="fas fa-business-time"></i> แสดงข้อมูลครุภัณฑ์</h5>
