      ...
      <div class="row">
                ...
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      $start = ($page - 1) * $show;
                      $sqlSelect = "SELECT a.*, t.name ,s.status_name,p.purchase_date FROM durable_articles as a, durable_articles_type as t ,status as s ,durable_articles_purchase as p";
                      $sqlSelect .= " WHERE a.type = t.id and p.product_id = a.id and a.status = s.id and a.status != 0 ";
                      ...
                      ?>
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            ...
                            <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="ยกเลิกข้อมูล" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#remove-articles').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            $sqlSelectCount .= " WHERE a.type = t.id and p.product_id = a.id and a.status = s.id and a.status != 0";
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการยกเลิกข้อมูลครุภัณฑ์ (ครุภัณฑ์)ใช่หรือไม่
