...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT r.*, m.code ,m.attribute ,m.name , m.picture ,au.Aname ,au.position ,au.rank FROM durable_material as m ,durable_material_repair as r ,auditor as au WHERE r.id = $id";
