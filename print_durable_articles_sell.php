...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT s.*, a.code , a.picture ,au.Aname ,au.position ,au.rank FROM durable_articles_sell as s,durable_articles as a ,auditor as au WHERE s.id = $id";
    ...
    <div class="col-sm-8 offset-sm-2">
      <div class="table-responsive" align="center">
        <table width="600" border="1" align="center">
          <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลการขายทอดตลาด(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
          <form>
            <div class="card-body">
              <div class="row">
