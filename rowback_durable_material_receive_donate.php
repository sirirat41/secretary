              ...
              <nav class="navbar navbar-light bg-light justify-content-between">
                ...
                <form class="form-inline">
                  <div>
                    ...
                    <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" class="btn btn-outline-info" onclick="window.location.href = 'display_durable_material_receive_donate.php';">
                  ...
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET["keyword"])) {
                        ...
                        $sqlSelect .= " and (a.code like '%$keyword%' or d.donate_name like '%$keyword%' or d.document_no like '%$keyword%' or d.receive_date like '%$keyword%')";
                      }
                      //echo $sqlSelect;
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="กู้คืนข้อมูล" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#rowback-receive_donate').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              ...
              $sqlSelectCount .= " and (a.code like '%$keyword%' or d.donate_name like '%$keyword%' or d.document_no like '%$keyword%' or d.receive_date like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการกู้ข้อมูลรับบริจาควัสดุใช่หรือไม่
          <form id="form-rowback" method="post" action="service/service_rowback_durable_material_receive_donate.php">
