            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-business-time"></i> แสดงข้อมูลการจัดซื้อ(วัสดุสิ้นเปลือง)</h6>
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_supplies_purchase.php';">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการกู้ข้อมูลชำรุดของวัสดุสิ้นเปลืองใช่หรือไม่
          <form id="form-rowback" method="post" action="service/service_rowback_supplies_purchase.php">
