...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT *, s.name as seller_name, t.name as durable_articles_type_name, u.name as unit_name, s.tel seller_tel, s.fax seller_fax, s.address seller_address, p.document_no document_no FROM durable_articles_purchase as p 
  LEFT JOIN durable_articles as a ON a.id = p.product_id 
            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h5 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-business-time"></i> ข้อมูลการจัดซื้อ (ครุภัณฑ์)</h5>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label class="text-dark body-text" for="number">จำนวนปีครุภัณฑ์ : </label>
                      <?php echo ($row["number"]); ?>
                    </div>
                  </div>
                </div>
