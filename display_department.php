      ...
      <div class="row">
              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="เพิ่มข้อมูล" type="button" onclick="window.location.href='insert_department.php';">
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center">
                          <td><a class="nav-link active body-text" href='display_department_ddl.php?id=<?php echo $row['id']; ?>'>
                              <?php echo $row["fullname"]; ?></a></td>
                          <td class="body-text"><?php echo ($row["shortname"]); ?></td>
                          <td class="body-text"><?php echo ($row["bulding"]); ?></td>
                          <td class="body-text"><?php echo ($row["floor"]); ?></td>
                          <td class="body-text"><?php echo ($row["tel"]); ?></td>
                          <td class="body-text"><?php echo ($row["fax"]); ?></td>

                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="แก้ไขข้อมูล" onclick="window.location = 'edit_department.php?id=<?php echo $row['id']; ?>'">
                              <i class="fas fa-pencil-alt"></i>
                            </button>
                            <button type="button" rel="tooltip" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="ดูรายละเอียดข้อมูล" onclick="window.location = 'view_department.php?id=<?php echo $row['id']; ?>'">
                            ...
                            <button type="button" rel="tooltip" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="ยกเลิกข้อมูล" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#remove-department').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (fullname like '%$keyword%' or shortname like '%$keyword%' or bulding like '%$keyword%' or floor like '%$keyword%' or tel like '%$keyword%' or fax like '%$keyword%')";
            }
...
<form action="printall_department.php" method="get" id="form-print" target="_blank">
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title " id="exampleModalLabel">แจ้งเตือน</h5>
