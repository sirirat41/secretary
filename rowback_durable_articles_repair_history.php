      ...
      <div class="row">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light justify-content-between">
                <h5 class="m-0 font-weight-bold text-danger body-text"><i class="fas fa-wrench"></i> แสดงรายละเอียดการซ่อม(ครุภัณฑ์)</h5>
                <form class="form-inline">
                  <div>
                    ...
                    <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" class="btn btn-outline-info" onclick="window.location.href = 'display_durable_articles_repair_history.php';">
                ...
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      $start = ($page - 1) * $show;
                      $sqlSelect = "SELECT h.*, a.code FROM durable_articles_repair_history as h, durable_articles as a";
                      $sqlSelect .= " WHERE h.repair_id = a.id and h.status = 0";
                      if (isset($_GET["keyword"])) {
                        $keyword = $_GET["keyword"];
                        $sqlSelect .= " and (a.code like '%$keyword%' or h.fix like '%$keyword%' or h.receive_date like '%$keyword%')";
                      }
                      //echo $sqlSelect;
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="กู้คืนข้อมูล" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#rowback-repair_history').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <?php
            $sqlSelectCount = "SELECT h.*, a.code FROM durable_articles_repair_history as h, durable_articles as a";
            $sqlSelectCount .= " WHERE h.repair_id = a.id and h.status = 0";
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (a.code like '%$keyword%' or h.fix like '%$keyword%' or h.receive_date like '%$keyword%')";
            }
