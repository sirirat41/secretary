...
<body id="page-top">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger">
                <i class="fas fa-box-open"></i> แก้ไขข้อมูลการโอนออก(ครุภัณฑ์)</h6>
            </div>
            <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-10 ">
                          <select class="form-control body-text" name="product_id" id="product_id" value="<?php echo $item["product_id"]; ?>">
                            <?php
                            $sqlSelectType = "SELECT * FROM durable_articles WHERE status != 0 and status != 2 and status != 3 and status != 4 and status != 8 and status != 9 and status != 10";
  ...
  <script>
    ...
    function search() {
      ...
      $.ajax({
        url: 'service/service_search_json_durable_articles_transefer_out.php?keyword=' + keyword,
        dataType: 'JSON',
        type: 'GET',
