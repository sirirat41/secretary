...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT s.*, m.code ,m.picture ,m.attribute,m.name FROM durable_material_sell as s,durable_material as m WHERE s.id = $id";
            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-hand-holding-usd"></i> ข้อมูลการขายทอดตลาด(วัสดุคงทน)</h6>
            </div>
            </nav>
            <form>
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <label class="text-dark body-text" for="sell_date">วันที่ขาย : </label>
                        <?php echo ($row["sell_date"]); ?>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <label class="text-dark body-text" for="buyer">ชื่อผู้ซื้อ : </label>
                        <?php echo ($row["buyer"]); ?>
                      </div>
                    </div>
                    <div class="row">
