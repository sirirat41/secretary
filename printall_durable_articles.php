        ...
        <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
                ...
                <h6 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลครุภัณฑ์ของสำนักงานเลขานุการตำรวจแห่งชาติ</h6>
                     <form>
                        <thead>
                    ...
                    <tbody>
                    <?php
                 $sqlSelect = "SELECT a.*, t.name ,s.status_name,p.purchase_date ,p.number FROM durable_articles as a, durable_articles_type as t ,status as s ,durable_articles_purchase as p";
