...
<body id="page-top">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group body-text">
                      ...
                      <input type="date" class="form-control body-text" name="transfer_date" id="transfer_date" placeholder="" value="<?php echo $newreceiveDate; ?>">
                      ...
                      <div class="row">
                        <div class="col-10 ">
                          <select class="form-control body-text" name="product_id" id="product_id">
                            <?php
                            $sqlSelectType = "SELECT * FROM durable_material WHERE status != 0 and status != 2 and status != 3 and status != 4 and status != 7 and status != 8 and status != 9";
                ...
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control body-text" id="transfer_from" name="transfer_from" placeholder="" value="<?php echo $item["transfer_from"]; ?>">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group body-text">
                      ...
                      <textarea class="form-control body-text" id="flag" name="flag" rows="3" placeholder=""><?php echo $item["flag"]; ?></textarea>
  ...
  <script>
    ...
    function search() {
      ...
      $.ajax({
        url: 'service/service_search_json_durable_material_transfer_in.php?keyword=' + keyword,
        dataType: 'JSON',
        type: 'GET',
