...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT r.*, m.code , m.picture ,au.Aname ,au.position ,au.rank FROM durable_material as m,durable_material_repair_history as r ,auditor as au WHERE r.id = $id";
    ...
    <div class="col-sm-8 offset-sm-2">
      <div class="table-responsive">
        <table width="600" border="1" align="center">
          <h7 class="m-3 font-weight-bold " align="center"> ข้อมูลรายละเอียดการซ่อม(วัสดุคงทน)</h7>
          <form>
            <div class="card-body">
              <div class="row">
