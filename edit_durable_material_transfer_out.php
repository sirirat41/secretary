...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM durable_material_transfer_out as t ,durable_articles as a WHERE t.id = $id";
                ...
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control body-text" name="transfer_to" id="transfer_to" placeholder="" value="<?php echo $item["transfer_to"]; ?>">
