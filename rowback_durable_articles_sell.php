      ...
      <div class="row">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light justify-content-between">
                <h6 class="m-0 font-weight-bold text-danger body-text"><i class="fas fa-hand-holding-usd"></i> แสดงข้อมูลการขายทอดตลาด(ครุภัณฑ์)</h6>
                ...
                <form class="form-inline">
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_articles_sell.php';">
                ...
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      $sqlSelect .= " WHERE s.product_id = a.id and s.status = 0";
                      if (isset($_GET["keyword"])) {
                        $keyword = $_GET["keyword"];
                        $sqlSelect .= " and (a.code like '%$keyword%' or s.document_no like '%$keyword%' or s.buyer like '%$keyword%' or s.sell_date like '%$keyword%')";
                      }
                      //echo $sqlSelect;
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="กู้คืนข้อมูล" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#rowback-sell').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            $sqlSelectCount .= " WHERE s.product_id = a.id and s.status = 0";
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (a.code like '%$keyword%' or s.document_no like '%$keyword%' or s.buyer like '%$keyword%' or s.sell_date like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการกู้ข้อมูลการขายทอดตลาดครุภัณฑ์ใช่หรือไม่
          <form id="form-rowback" method="post" action="service/service_rowback_durable_articles_sell.php">
