...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT d.*, a.code ,a.picture ,a.attribute ,a.model FROM durable_articles_receive_donate as d, durable_articles as a WHERE d.id = $id";
  $sql .= " and d.product_id = a.id and d.status = 1 ";
