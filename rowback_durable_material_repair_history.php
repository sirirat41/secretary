          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light justify-content-between">
                <h6 class="m-0 font-weight-bold text-danger body-text"><i class="fas fa-wrench"></i> แสดงรายละเอียดการซ่อม(วัสดุคงทน)</h6>
                ...
                <form class="form-inline">
                  <div>
                    ...
                    <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" class="btn btn-outline-info" onclick="window.location.href = 'display_durable_material_repair_history.php';">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการกู้ข้อมูลรายละเอียดการซ่อมวัสดุใช่หรือไม่
          <form id="form-rowback" method="post" action="service/service_rowback_durable_material_repair_history.php">
