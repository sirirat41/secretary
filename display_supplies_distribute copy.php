                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="แก้ไขข้อมูล" onclick="window.location = 'edit_supplies_distribute.php?id=<?php echo $row['id']; ?>'">
            ...
            for ($i = $start_i; $i < $end_i; $i++) {
              ...
              <?php
                ...
                if (isset($_GET["keyword"]) && isset($_GET["id"])) {
                  ?>
                <li class="page-item"><a class="page-link" href="?id=<?php echo $_GET["id"]; ?>&page=<?php echo ($i + 1); ?>&keyword=<?php echo $_GET["keyword"]; ?>"><?php echo ($i + 1); ?></a></li>
              <?php
                } else {
                  ?>
                <li class="page-item"><a class="page-link" href="?id=<?php echo $_GET["id"]; ?>&page=<?php echo ($i + 1); ?>"><?php echo ($i + 1); ?></a></li>
                <?php
