...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT r.*, m.code ,m.picture FROM durable_material as a,durable_material_repair_history as r WHERE r.id = $id";
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <label class="text-dark body-text" for="receive_date">วันที่ซ่อม : </label>
                        <?php echo ($row["receive_date"]); ?>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <label class="text-dark body-text" for="fix">รายการซ่อมครุภัณฑ์ : </label>
                        <?php echo ($row["fix"]); ?>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <label class="text-dark body-text" for="price">ราคา : </label>
                        <?php echo ($row["price"]); ?>
                      </div>
                    </div>
                    <div class="row">
