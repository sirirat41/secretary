              ...
              <nav class="navbar navbar-light bg-light justify-content-between">
                ...
                <form class="form-inline">
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_material_sell.php';">
                  ...
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET["keyword"])) {
                        ...
                        $sqlSelect .= " and (m.code like '%$keyword%' or s.document_no like '%$keyword%' or s.sell_date like '%$keyword%' or s.buyer like '%$keyword%')";
                      }
                      //echo $sqlSelect;
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              ...
              $sqlSelectCount .= " and (m.code like '%$keyword%' or s.document_no like '%$keyword%' or s.sell_date like '%$keyword%' or s.buyer like '%$keyword%')";
            }
