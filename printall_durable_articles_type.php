        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table width="100%" border="1">
              <h6 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลประเภท(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h6>
              <form>
                <thead>
                  <tr class="text-center">
                    ...
                    <th>
                      <font size="2">ชื่อประเภทครุภัณฑ์</font>
                    </th>
                    <th>
                      <font size="2">ชื่อย่อประเภทครุภัณฑ์</font>
                    </th>
                  </tr>
                </thead>
                <tbody>
