      ...
      <div class="row">
            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-fw fa-house-damage"></i> แสดงข้อมูลชำรุด(วัสดคงทน)</h6>
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_material_damage.php';">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            $sqlSelectCount .= " WHERE da.product_id = m.id and da.status = 0";
            if (isset($_GET["keyword"])) {
              $kyweord = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (da.damage_date like '%$keyword%' or m.code like '%$keyword%')";
            }
