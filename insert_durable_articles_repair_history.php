        ...
        <div class="col-md-6 offset-md-3">
          <div class="card shado mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger body-text"><i class="fas fa-wrench"></i> เพิ่มข้อมูลรายละเอียดการซ่อม(ครุภัณฑ์)</h6>
            </div>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover ">
                      ...
                      <tbody id="modal-articles-body">
                        ...
                        $sqlSelect .= " WHERE r.damage_id = a.id and r.status = 4";
   ...
   var itemPerPage = 10; //จำนวนข้อมูล
    ...
    function changePage(page) {
      ...
      for (let i = start; i < max; i++) {
        ...
        $('<td>' + thaiNumber(repair_date) + '</td>').appendTo(tr);
        $('<td>' + thaiNumber(code) + '</td>').appendTo(tr);
        $('<td>' + thaiNumber(attribute) + '</td>').appendTo(tr);
        $('<td>' + thaiNumber(model) + '</td>').appendTo(tr);
