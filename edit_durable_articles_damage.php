...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM durable_articles_damage as d ,durable_articles as a WHERE d.id = $id";
      ...
      <div class="row ">
        <div class="col-8 offset-2">
          <div class="card">
            ...
            <br>
            <div class="card-body">
              <form method="post" action="service/service_edit_durable_articles_damage.php?id=<?php echo $id; ?>" id="form_insert">
                <div class="row">
                  <div class="col-md-12 ">
                ...
                <div class="row">
                  <div class="col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control" name="damage_date" type="date" placeholder="" id="damage_date" value="<?php echo $newOrderDate; ?>">
                  ...
                  <div class="col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control" name="flag" type="text" placeholder="" id="flag" value="<?php echo $item["flag"]; ?>">
          ...
          <div class="row">
            <div class="col-12 card" style="padding: 10px" align="center">
              ...
              <p id="label_empty_history">วัสดุคงทน ชิ้นนี้ไม่มีประวัติการชำรุด</p>
