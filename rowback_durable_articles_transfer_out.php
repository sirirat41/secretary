              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_articles_transfer_out.php';">
                  ...
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET["keyword"])) {
                        ...
                        $sqlSelect .= " and (trans.product_id like '%$keyword%' or trans.transfer_date like '%$keyword%' or trans.transfer_to like '%$keyword%' or ar.code like '%$keyword%' or ar.attribute like '%$keyword%')";
                      }
                      // echo $sqlSelect;
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center body-text">
                          ...
                          <td class="td-actions text-center">
                            <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="กู้คืนข้อมูล" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#rowback-transfer_out').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              ...
              $sqlSelectCount .= " and (trans.product_id like '%$keyword%' or trans.transfer_date like '%$keyword%' or trans.transfer_to like '%$keyword%' or ar.code like '%$keyword%' or ar.attribute like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          ...
          <form id="form-rowback" method="post" action="service/service_rowback_durable_articles_transfer_out.php">
