        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table width="100%" border="1" class="landscape">
              <h6 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลชำรุด(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h6>
              <form>
                <thead>
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr class="text-center">
                      ...
                      <td>
                        <font size="2"><?php echo ($row["damage_date"]); ?></font>
                      </td>
                      <td>
