            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger body-text">
                  <i class="fas fa-business-time"></i> แสดงข้อมูลการจัดซื้อ(วัสดุ)</h6>
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_material_purchase.php';">
                  ...
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET["keyword"])) {
                        ...
                        $sqlSelect .= " and (order_no like '%$keyword%' or purchase_date like '%$keyword%' or number like '%$keyword%' or order_by like '%$keyword%')";
                      }
                      // echo $sqlSelect;
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              ...
              $sqlSelectCount .= " and (order_no like '%$keyword%' or purchase_date like '%$keyword%' or number like '%$keyword%' or order_by like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          คุณต้องการกู้ข้อมูลจัดซื้อของวัสดุฑ์ใช่หรือไม่
          <form id="form-rowback" method="post" action="service/service_rowback_durable_material_purchase.php">
