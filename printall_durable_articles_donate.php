        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table width="100%" border="1" class="landscape">
              <h6 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลการบริจาคออก(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ </h6>
              <form>
                <thead>
                  <tr class="text-center">
                    ...
                    <th>
                      <font size="2">ชื่อบริจาค</font>
                    </th>
                    <th>
                      <font size="2">วันที่บริจาคออก</font>
                    </th>
                    <th>
                ...
                <tbody>
                  <?php
                  $sqlSelect = "SELECT da.*, a.code FROM durable_articles_donate as da, durable_articles as a";
