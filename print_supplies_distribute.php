...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT dis.*, s.code,d.fullname , s.picture ,au.Aname ,au.position ,au.rank FROM auditor as au , supplies_distribute as dis , supplies as s ,department as d WHERE dis.id = $id";
    ...
    <div class="col-md-8 offset-2">
      <div class="table-responsive" align="center">
        <table width="600" border="1" align="center">
          <h7 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลการแจกจ่าย(วัสดุสิ้นเปลือง)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
          <form>
            <form>
              <div class="card-body">
                <div class="row">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h7 class="modal-title" id="exampleModalLabel">Ready to Leave?</h5>
