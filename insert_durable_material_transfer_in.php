          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger">
                <i class="fas fa-box-open"></i> เพิ่มข้อมูลการโอนเข้า(วัสดุคงทน)</h6>
            </div>

            <div class="card-body">
              <form method="post" action="service/service_insert_durable_material_transfer_in.php" id="form_insert">
                <div class="row">
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="form-group ">
                      ...
                      <input type="text" class="form-control" name="transfer_from" id="transfer_form" placeholder="name">
                    </div>
                  </div>
                </div>
                <div class="row">
