      ...
      <div class="row">
              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_articles_transfer_in.php';">
                  ...
                  <table class="table table-hover ">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET["keyword"])) {
                        ...
                        $sqlSelect .= " and (trans.product_id like '%$keyword%' or trans.transfer_date like '%$keyword%' or trans.transfer_from like '%$keyword%' or ar.code like '%$keyword%' or ar.attribute like '%$keyword%')";
                      }
                      // echo $sqlSelect;
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <?php
            $sqlSelectCount = "SELECT trans.*, ar.code FROM durable_articles as ar, durable_articles_transfer_in as trans";
            $sqlSelectCount .= " WHERE trans.product_id = ar.id and trans.status = 0";
            if (isset($_GET["keyword"])) {
              $keyword = arabicnumDigit($_GET["keyword"]);
              $sqlSelectCount .= " and (trans.product_id like '%$keyword%' or trans.transfer_date like '%$keyword%' or trans.transfer_from like '%$keyword%' or ar.code like '%$keyword%' or ar.attribute like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          ...
          <form id="form-rowback" method="post" action="service/service_rowback_durable_articles_transfer_in.php">
