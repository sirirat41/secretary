                    ...
                    <?php
                      ...
                      <tr class="text-center body-text">
                        ...
                        <td class="td-actions text-center">
                          ...
                          <button type="button" rel="tooltip" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="ลบข้อมูล" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#remove-user').val('<?php echo $id; ?>')">
