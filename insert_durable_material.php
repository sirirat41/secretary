            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row" >
                        <div class=" col-6 " >
                              <div class="form-group bmd-form-group">
                                <label class="bmd-label-floating">ส่วนของราชการ :</label>
                                <input class="form-control" type="text"autocomplete="off"  placeholder="code" value=""  required>
                              </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                    ...
                    <div class="row" >
                      <div class=" col-6 " >
                            <div class="form-group bmd-form-group">
                              <label class="bmd-label-floating">รหัสวัสดุ (คงทน)</label>
                              <input class="form-control" type="text"autocomplete="off"  placeholder="code" value=""  required>
                            </div>
                      </div>
                      <div class="col-6 ">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group bmd-form-group">
                            ...
                            <input class="form-control" type="text" placeholder="attribute">
                        </div>
                    </div>
                        <div class="col-6 ">
                            <div class="form-group bmd-form-group">
                                <label class="bmd-label-floating">ชื่อวัสดุ (คงทน) :</label>
                                <input class="form-control" type="text" placeholder="namemeterial">
                            </div>
                        </div>
                    </div>
                    <div class="row">
