...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT t.*, m.code ,m.attribute , m.name ,m.picture ,au.Aname ,au.position ,au.rank FROM durable_material as m,durable_material_transfer_in as t ,auditor as au WHERE t.id = $id";
