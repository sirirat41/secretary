...
if (isset($_GET['id'])) {
    ...
    $updatePurchase .= " order_by = '$orderBy', receiver = '$receiver',purchase_date = '$purchase_date' ,receive_date = '$receiveDate', receive_address = '$receiviceAddress', document_no = '$document_no'";
