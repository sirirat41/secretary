...
if (isset($_GET["keyword"])) {
    ...
    $sqlSelect = "SELECT a.*, t.name ,ss.type FROM supplies as s,supplies_stock as ss , durable_material_type as t";
    $sqlSelect .= " WHERE s.supplies_id = ss.id and ss.type = t.id and s.status = 1";
