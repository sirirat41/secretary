...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        header('Location: ../insert_durable_material_repair_history.php?message=เพิ่มข้อมูลสำเร็จ');
    } else {
        header('Location: ../insert_durable_material_repair_history.php?message=เพิ่มข้อมูลไม่สำเร็จ กรุณาลองอีกครั้ง');
    }
