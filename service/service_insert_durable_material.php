...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < $number; $i++) {
        ...
        $sqlInsertPurchase = "INSERT INTO durable_material_purchase (product_id, order_no, purchase_date, seller_id, receiver, order_by, receive_date, receive_address, number)";
        $sqlInsertPurchase .= " VALUES($productID, '$order_no', $purchase_date , $seller_id, '$receiver', '$order_by', '$receive_date', '$receive_address', $number)";
