        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table width="100%" border="1" class="landscape">
              <h6 class="m-3 font-weight-bold " align="center">การเก็บข้อมูลจำนวนคงเหลือ(วัสดุสิ้นเปลือง)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h6>
              <form>
                <thead>
                  <tr class="text-center">
                    ...
                    <th>
                      <font size="2">ชื่อวัสดุ</font>
                    </th>
                    <th>
                      <font size="2">จำนวนคงเหลือ</font>
                    </th>
                    <th>
