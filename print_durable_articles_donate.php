...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT d.*, m.code , m.picture , a.rank ,a.Aname ,a.position FROM durable_articles_donate as d, durable_articles as m ,auditor as a WHERE d.id = $id";
    ...
    <div class="col-md-10 offset-1">
      <div class="table-responsive" align="center">
        <table width="600" border="1" align="center">
          <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลการบริจาคออก(ครุภัณฑ์)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
