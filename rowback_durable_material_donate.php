              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="แสดงข้อมูล" type="button" onclick="window.location.href='display_durable_material_donate.php';">
                ...
                <div class="table-responsive">
                  <table class="table table-hover ">
                    ...
                    if (isset($_GET["keyword"])) {
                      ...
                      $sqlSelect .= " and (do.document_no like '%$keyword%' or a.code like '%$keyword%'or do.donate_name like '%$keyword%'or do.receive_date like '%$keyword%')";
                    }
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr class="text-center body-text">
                        ...
                        <td class="td-actions text-center">
                          <button type="button" rel="tooltip" data-toggle="tooltip" data-placement="top" title="กู้คืนข้อมูล" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" onclick="$('#exampleModal').modal();$('#rowback-donate').val('<?php echo $id; ?>')">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            if (isset($_GET["keyword"])) {
              ...
              $sqlSelectCount .= " and (do.document_no like '%$keyword%' or a.code like '%$keyword%'or do.donate_name like '%$keyword%'or do.receive_date like '%$keyword%')";
            }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-left body-text">
          ...
          <form id="form-rowback" method="post" action="service/service_rowback_durable_material_donate.php">
            <input type="hidden" id="rowback-donate" name="donate_id">
          </form>
        </div>
        <div class="modal-footer">
