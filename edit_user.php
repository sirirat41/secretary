                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control body-text" name="password" id="inputpassword" aria-describedby="password" placeholder="password" value="<?php echo $item["password"]; ?>">
                    </div>
                  </div>
                </div>
