...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT p.*, m.code ,m.attribute ,m.name , m.picture ,au.Aname ,au.position ,au.rank FROM durable_material_purchase as p ,durable_material as m ,auditor as au WHERE p.id = $id";
  $sql .= " and p.product_id = m.id";
  ...
  <div class="col-sm-12">
    <div class="table-responsive" align="center">
      <table width="900" border="1" align="center">
        <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลการจัดซื้อ(วัสดุคงทน)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
        <form>
          <div class="card-body">
            <div class="row">
