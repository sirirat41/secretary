...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT t.*, a.code ,a.attribute ,a.name ,a.picture FROM durable_material as a,durable_material_transfer_out as t WHERE t.id = $id";
            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h5 class="m-0 font-weight-bold text-danger">
                  <i class="fas fa-box-open"></i> ข้อมูลการโอนออก(วัสดุคงทน)</h5>
            </div>
            </nav>
            <form>
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="row">
                      <div class="col-md-12">
                        <label class="text-dark body-text" for="document_no">เลขที่หนังสือ : </label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <label class="text-dark body-text" for="transfer_date">วันที่โอน : </label>
                        <?php echo ($row["transfer_date"]); ?>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <label class="text-dark body-text" for="transfer_to">ชื่อผู้โอนให้ : </label>
