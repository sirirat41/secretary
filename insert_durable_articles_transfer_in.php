      ...
      <div class="row">
        <div class="col-md-8 offset-2">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form method="post" action="service/service_insert_durable_articles_transfer_in.php" id="form_insert">
                <div class="row">
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="form-group body-text">
                      ...
                      <input type="text" class="form-control" id="transfer_from" name="transfer_from" placeholder="">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group body-text">
                      ...
                      <textarea class="form-control" id="flag" name="flag" rows="3" placeholder=""></textarea>
