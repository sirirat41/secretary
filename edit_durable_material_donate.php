...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM durable_material_donate as d,durable_articles as a WHERE d.id = $id";
                ...
                <div class="row">
                  <div class=" col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control body-text" name="document_no" type="text" id="document_no" placeholder="" value="<?php echo $item["document_no"]; ?>">
                  ...
                  <div class="col-6">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control body-text" name="receive_date" type="date" id="receive_date" placeholder="" value="<?php echo $newOrderDate; ?>">
                      ...
                      <div class="row">
                        <div class="col-10 ">
                          <select class="form-control body-text" name="product_id" id="product_id">
                            <?php
                            $sqlSelectType = "SELECT * FROM durable_material WHERE status = 8";
                ...
                <div class="row">
                  <div class=" col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control body-text" name="donate_name" type="text" placeholder="" id="donate_name" value="<?php echo $item["donate_name"]; ?>">
                  ...
                  <div class="col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control body-text" name="flag" name="flag" type="text" placeholder="" id="flag" value="<?php echo $item["flag"]; ?>">
