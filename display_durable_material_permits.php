              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <div>
                    ...
                    <a rel="tooltip" class="btn btn-outline-primary" href="printall_durable_material_permits.php" target="_blank">
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center">
                          ...
                          <td class="td-actions text-center">
                            ...
                            <a rel="tooltip" class="btn btn-primary" style="color: white" href="print_durable_material_permits.php?id=<?php echo $row['id']; ?>" target="_blank">
                              <i class="fas fa-print"></i>
                            </a>
