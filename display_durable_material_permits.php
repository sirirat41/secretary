              ...
              <nav class="navbar navbar-light bg-light">
                ...
                <form class="form-inline">
                  ...
                  <button class="btn btn-outline-danger" type="submit">
                    ...
                    <button class="btn btn-outline-info" type="button" onclick="window.location.href='insert_durable_material_permits.php';">
                      <i class="fas fa-plus"></i>
                    </button>
                    <button class="btn btn-outline-warning" type="button" onclick="window.location.href='rowback_durable_material_permits.php';">
                      <i class="fas fa-sync-alt"></i>
                    </button>
                    <button class="btn btn-outline-primary" type="button" onclick="window.location.href='print_durable_material_permits.php';">
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="text-center">
                          ...
                          <button type="button" rel="tooltip" class="btn btn-warning"
                            ...
                            <button type="button" rel="tooltip" class="btn btn-success" onclick="window.location = 'view_durable_material_permits.php?id=<?php echo $row['id']; ?>'">
                              <i class="fas fa-clipboard-list"></i>
                            </button>
                            <button type="button" rel="tooltip" class="btn btn-primary" onclick="window.location.href='print_durable_material_permits.php';">
                            <i class="fas fa-print"></i>
                          </button>
