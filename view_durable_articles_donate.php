            ...
            <div class="card-header py-3">
              <nav class="navbar navbar-light bg-light">
                <h6 class="m-0 font-weight-bold text-danger">
                  <i class="fas fa-business-time"></i> ข้อมูลการบริจาคออก (ครุภัณฑ์)</h6>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label class="text-dark" for="receive_date">วันที่บริจาค : </label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label class="text-dark" for="model">ร่นแบบ : </label>
