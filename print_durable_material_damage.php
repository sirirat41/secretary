...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT d.*, m.code , m.picture ,au.Aname ,au.position ,au.rank FROM durable_material_damage as d, durable_material as m ,auditor as au WHERE d.id = $id";
    ...
    <div class="col-md-8 offset-2">
      <div class="table-responsive" align="center">
        <table width="500" border="1" align="center">
          <h7 class="m-3 font-weight-bold " align="center"> การเก็บข้อมูลชำรุด(วัสดุคงทน)ของสำนักงานเลขานุการตำรวจแห่งชาติ</h7>
