        ...
        <div class="col-6 offset-3">
          <div class="card">
            <div class="card-header card-header-text card-header-danger">
              <div class="card-text">
                <h6 class="m-0 font-weight-bold text-danger body-text body-text">
            ...
            <br>
            <div class="card-body">
              <form method="post" action="service/service_insert_durable_articles_damage.php" id="form_insert">
                <div class="row">
                  <div class="col-12 ">
                ...
                <div class="row">
                  <div class="col-6 ">
                    <div class="form-group bmd-form-group body-text">
                      ...
                      <input class="form-control body-text" name="damage_date" type="date" placeholder="damage_date" id="damage_date">
                    </div>
                  </div>
                  <div class="col-6 ">
                    <div class="form-group bmd-form-group body-text">
